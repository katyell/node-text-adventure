...
export function gameReducer(state, action) {
  switch (action.type) {
    case 'START_GAME': {
      ...
      const started = { ...state, screen: 'game', visited, output: [] }
    ...
    case 'COMMAND': {
      ...
      let s = {
        ...state,
        output: [...state.output, { type: 'input', text: raw }],
      }
      ...
      switch (cmd.verb) {
        ...
        case 'UNKNOWN':
        default:
          return append(s, "I don't understand that. Type HELP for a list of commands.")
      }
    }
